...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer: //refactored as function in cards.c
			return adventurerAction(currentPlayer, state, temphand);
    ...
    case smithy: //refactored as function in cards.c
    ...
    case steward: //Refactored to function in cards.c
			return stewardAction(choice1, choice2, choice3, currentPlayer, state, handPos);
     /* if (choice1 == 1)
	{
	  //+2 cards
	  drawCard(currentPlayer, state);
    ...
    case embargo: //Refactored as function in cards.c
			return embargoAction(choice1, currentPlayer, state, handPos);

    case outpost: //Refactored as function in cards.c
			return outpostAction(currentPlayer, state, handPos);
